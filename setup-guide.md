...
Finally, after packaging the project, you will need to create a new folder called Plugins on the Your_BuildRootDirectory > Your_Project folder, and paste there the HISPlayer folder plugin (similar to the Import Package step)
